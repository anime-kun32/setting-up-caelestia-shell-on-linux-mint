...
- Quickshell
- Caelestia Shell
- Complete Hyprland configuration with all keybindings
...
4. [Layout Keybindings](#layout-keybindings)
...
Copy and paste the complete Hyprland Lua configuration below:

```lua
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
-- HYPRLAND + CAELESTIA SHELL CONFIGURATION            --
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
...
| Keybinding | Action |
|------------|--------|
| `SUPER + J` | Toggle split (Dwindle only) |
